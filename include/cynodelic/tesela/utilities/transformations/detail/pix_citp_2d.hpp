...
/** 
 * @file pix_citp_2d.hpp
 *
 * @brief Defines the `pix_citp_2d` function.
 */

#ifndef CYNODELIC_TESELA_UTILITIES_TRANSFORMATIONS_DETAIL_PIX_CITP_2D_HPP
#define CYNODELIC_TESELA_UTILITIES_TRANSFORMATIONS_DETAIL_PIX_CITP_2D_HPP
...
{
	/**
	 * @brief Two-dimensional cosine interpolation function for pixel types
	 */
	inline rgb_t pix_citp_2d(
		const rgb_t& pix_00,
		const rgb_t& pix_01,
		const rgb_t& pix_10,
		const rgb_t& pix_11,
...
#endif // CYNODELIC_TESELA_UTILITIES_TRANSFORMATIONS_DETAIL_PIX_CITP_2D_HPP
